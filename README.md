...
2. URL: `https://github.com/seu-usuario/correios-tracker-ha` | Tipo: Integração
...
Instale o card separado: [correios-tracker-card](https://github.com/seu-usuario/correios-tracker-card)
